// Only the free 14-day trial is offered on the site today. The paid tiers stay
// defined so the billing code keeps working, but nothing links to them until
// there is a customer approaching the end of a trial.
//
...
const PLANS = {
  free:     { name: "Free trial", price: 0,   texts: 100,  sites: 1,  dedicatedNumber: false, branding: true, trialDays: 14 },
