<!-- ============ WIDGET START (this is what you embed) ============ -->
<div id="bfh-chat"></div>
<script>
(function () {
  "use strict";
  ...
  /* =================== CONFIG =================== */
  const CONFIG = {
    webhookUrl: "https://bfh-lead-relay.vercel.app/api/chat",
    agentName: "Kai",            // the friendly name the chat greets with
    ...
    bubbleUser: "#27ae60",       // user message bubble color
    logoUrl: "https://cdn.shopify.com/s/files/1/0536/8771/3946/files/kai-avatar.jpg?v=1781164005",      // Kai's photo (embedded). Set "" to fall back to text logo.

    // ---- Conversation copy (edit freely) ----
    peekMessage: "Aloha! Kai here \uD83E\uDD19 Anything I can help you find?",
    askDetails: "Happy to help with that! Before I do \u2014 mind sharing your name, email & phone so I can follow up?",
    closing: "Thanks {name}! Let me double-check that for you and I'll get right back to you \u2014 keep an eye on your texts \uD83E\uDD19"
  };
  /* ============================================== */
  ...
  const avatarInner = CONFIG.logoUrl ? '<img src="' + CONFIG.logoUrl + '" alt="">' : "BEST<br>FLOOR";
  ...
  const startPage = (function () {
    const title = (document.title || "").replace(/\s*[\u2013\u2014|\-]\s*Best Flooring Honolulu.*$/i, "").trim();
  ...
  submitBtn.addEventListener("click", async function () {
    ...
    try {
      ...
      console.error("BFH chat submit error:", err);
    }
  });
})();
</script>
